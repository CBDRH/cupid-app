<script>
  ...
  // --- SUMMARY ARRAYS ---
  let useSummary = $state([0, 0, 0, 0]);
  let harmSummary = $state([0, 0, 0, 0]);
  let behavSummary = $state([0, 0, 0, 0]);
  let economicSummary = $state([0, 0, 0, 0]);
  ...
  let cards = ["Alcohol", "Nicotine", "Cannabis", "Other illicit drugs"]
  let useModals = $state([false, false, false, false])
  let harmModals = $state([false, false, false, false])
  let behavModals = $state([false, false, false, false])
  let economicModals = $state([false, false, false, false])
